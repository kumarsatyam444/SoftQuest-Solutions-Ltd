  ...
  return (
    <div className='w-full'>
      ...
      <div className='flex justify-between items-center w-full'>
        <div className='p-4 text-center text-md'>Trending Ads</div>
...
function GridViewCard({ vehicle }) {
  return (
    <div className='bg-white rounded-lg shadow-md overflow-hidden border w-full'>
      ...
      <div className='p-4'>
        ...
        <div className='flex justify-between items-center'>
          ...
          <p className='text-gray-500 text-sm truncate max-w-[100px]'>
            {vehicle.address}
          </p>
        </div>
      </div>
